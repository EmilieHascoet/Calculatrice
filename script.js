...
function TemplateCalc() {
    if (calc_est_base) {
        ...
        document.getElementById("templateCalc").style.gridTemplateRows = "minmax(150px, auto) repeat(7, 1fr) 1px";
        calc_est_base = false;
    } else {
        document.getElementById("templateCalc").style.gridTemplateColumns = "repeat(4, 1fr)";
        document.getElementById("templateCalc").style.gridTemplateRows = "minmax(150px, auto) repeat(5, 1fr) 1px";
        calc_est_base = true;
    }
}
